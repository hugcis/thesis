...
issues arise when scaling CAs to large sizes: \vspace{-5pt}
\begin{itemize}
...
by~\cite{hansonAttractorbasinPortraitCellular1992,
...
introduced in~\cite{wuenscheClassifyingCellularAutomata1999}. The author
...
More recent work by~\cite{shaliziAutomaticFiltersDetection2006} uses the
combination of a modified Lyapunov exponent approach with \emph{statistical
  complexity} \cite{shaliziQuantifyingSelfOrganizationOptimal2004} to underline
...
Hashlife \cite{gosperExploitingRegularitiesLarge1984} and other Game of
...
inefficient~\cite{wolframNewKindScience2002}. An optimally complex-behaving
...
Results in Table~\ref{experiments_table} suggest that using our proposed methods
