...
on the reduced grid. Figures reported in Table~\ref{experiments_table_vc} are
...
Results in Table~\ref{experiments_table_vc} suggest that using our proposed methods
