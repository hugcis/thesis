...
\begin{enumerate}
  \item The first sub-goal is to identify complex dynamical systems with the potential to exhibit
...
\end{figure}
  ...
  \item The second sub-goal is to measure the fraction of systems that have the most complex and rapidly
...
construct models that can develop autonomously without needing any external data or
...
open-ended way, we need metrics that can help select systems without being
another replacement objective function. We address this challenge in particular
...
\begin{enumerate}
  \item A literature review describing the connection between cellular automata
        ...
        endeavor, and we consider a review necessary for placing the rest of our
        work in its context.

  \item The development of a general complexity metric that can help identify
        complex systems with interesting behavior.

  \item The development of a coarse-graining method to visualize computations in
        cellular automata and other discrete systems with local interactions.
