...
algorithms, such as difficulties to generalize, robustness, or continual
learning. Natural intelligence seems to rely on emerging properties that are
selected through evolution. For example, biological life exhibits a pattern of
major evolutionary transitions where lower-level autonomously replicating
entities merge to form a single more complex corporate body. This is believed to
have happened for the emergence of eukaryotic cells as well as for multicellular
life \cite{hammerschmidtLifeCyclesFitness2014}.

Producing emerging phenomena similar to natural ones \emph{in silico} is
challenging. There is a long history of algorithms that attempt to apply
evolutionary design to solve particular tasks, called evolutionary algorithms.
