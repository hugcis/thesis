...
label, a number, or collection of numbers that represents the expected outcome
...
complex system: the \acl{CA}. This model has been extensively studied because of
its simple definition and surprisingly complex behavior. We provide a
thorough description of \aclp{CA} in Section \ref{sec:cellular-automata-sec}.


\section{Motivation}

Complex dynamical systems could overcome the issues with existing learning
algorithms, such as difficulties to generalize, robustness, or ability to learn
continually. The natural intelligence of biological systems seems to rely on
...
body. This is believed to have happened for the emergence of eukaryotic cells as
well as for multicellular life \parencite{hammerschmidtLifeCyclesFitness2014}.
All the complex and diverse biological entities have presumably emerged from a
single common ancestor and, even before, from inorganic components present on
...
similar to natural ones \emph{in silico} is challenging. There is a long history
...
But many of these methods focus on searching the space of solutions through
several variation mechanisms such as mutations and crossovers. While effective
to solve precise tasks, these methods obscure another crucial component of
