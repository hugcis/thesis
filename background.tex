...
registers and communication channels to build a Universal Computer, thereby
proving that this \ac{CA} is Turing-complete \parencite{IgblanLifeUniversal}.
This property is thought to be also shared by other \ac{CA}, making these models
...
Another family of \ac{CA} uses continuous state values, often restricted to the
...
Examples of continus \ac{CA} include Lenia
\parencite{chanLeniaBiologyArtificial2019a}, or \ac{NCA}
