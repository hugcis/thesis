...
\acp{CA} as a replacement of \acp{RNN} becomes natural. We describe the \acf{RC}
model (Section \ref{sec:res-models}), which enables sending inputs to, and
harvesting the computations of complex systems to solve problems and which we
apply in Chapter~\ref{cha:learn-effic-compl}. This model was developed with
\acp{RNN} but we describe how \acp{CA} can be a suitable replacement and the
...
constructing a self-replicating system
