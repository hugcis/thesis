...
1, the next state is 1''. The game of life is an example of totalistic \ac{CA} in
two dimensions.

\paragraph{Game of Life.}
The game of life is one of the most famous \ac{CA}. It was proposed by
mathematician John Conway in 1970 \parencite{gardnerMathematicalGames1970}. Its
rule can be summarized in one sentence as
