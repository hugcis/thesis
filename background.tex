...
Next, we describe the connection between \acp{CA} and \acfp{RNN}, which is
useful for understanding the characteristics and applications these two models share
(Section \ref{sec:cell-autom-rnns}). Finally, we describe the \acf{RC} model
(Section \ref{sec:res-models}), which enables harvesting the computations of
complex systems to solve problems, and which we apply in chapter
\ref{cha:learn-effic-compl}.
