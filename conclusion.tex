...
\begin{itemize}
  ...
  \item In Chapter \ref{cha:meas-compl-evolv}, we define a novel metric of
        ...
        to discover new \acp{CA} rules with surprisingly complex beahvior
        semi-automatically.

  \item In Chapter \ref{cha:visu-comp-large}, we built on the work of Chapter
        \ref{cha:meas-compl-evolv} to tackle the challenges posed by working
        with large-scale systems.

  \item In Chapter \ref{cha:learn-effic-compl}, we tackle the issue of using
        complex systems for general purpose task solving, using \ac{RC}
\end{itemize}
