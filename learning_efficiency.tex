...
In this paper we wish to investigate whether complex dynamical systems --- in
...
\section{Reservoir \ac{CA} results}
...
that was turned on in reaction to an input before could be overwritten by a
subsequent input.
