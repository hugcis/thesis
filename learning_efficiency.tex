...
\parencite[RNNs; ][]{elmanFindingStructureTime1990}, long short-term memory networks
\parencite[LSTMs;][]{hochreiterLongShortTermMemory1997} or Transformers
\parencite{vaswaniAttentionAllYou2017} lack essential properties such as learning
...
\parencite{jaegerEchoStateApproach2001}.
...
In this paper we wish to investigate whether complex dynamical systems --- in particular RNNs with frozen weights (echo-state networks) \parencite{jaegerEchoStateApproach2001} and reservoir cellular automata \cite{yilmazReservoirComputingUsing2014} ---
...
\bfseries 10 - Adjective QA \& counting &  0.04 ${\scriptscriptstyle \pm0.02 }$ & \bfseries 0.06 ${\scriptscriptstyle \pm0.02 }$ &  0.05 ${\scriptscriptstyle \pm0.02 }$ &  0.03 ${\scriptscriptstyle \pm0.02 }$  &  0.01 ${\scriptscriptstyle \pm0.01 }$& --- \\
    ...
    \caption{Comparison of WADE scores (also shown in parentheses in the legend
      ...
      automaton rules (\textbf{ReCA}, \parencite{yilmazReservoirComputingUsing2014}) for each task against an echo-state
      network (\textbf{ESN}, \parencite{jaegerEchoStateApproach2001}), a \textbf{RNN}, a \textbf{LSTM} \cite{hochreiterLongShortTermMemory1997}, and a
...
\parencite{boccaraModelingComplexSystems2010}.
