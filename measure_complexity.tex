...
properties can be observed in living organisms \parencite{booker_perspectives_2004}
...
\parencite{s_ray_approach_1991}, Sims \cite{sims_evolving_1994}, Avida
\parencite{ofria_avida:_2004}, Polyworld \cite{yaeger_computational_1994}, Geb
\parencite{channon_improving_2003}, Division Blocks \cite{spector_division_2007} and
Chromaria \parencite{soros_identifying_2014}. Designs focusing on an objective, and
making use of reinforcement learning methods to drive evolution are also being
studied, e.g. in \parencite{pathak_learning_2019}. Most of these simulated ``worlds''
